      ...
      >
        ...
        <div className="relative pt-12">
          ...
          <div className="mt-4 flex items-center justify-between gap-4">
            ...
            <button className="shrink-0 rounded-xl bg-green-600 px-5 py-3 text-xs font-black text-white shadow-lg shadow-green-600/20 transition duration-300 hover:-translate-y-0.5 hover:bg-green-500 sm:px-6 sm:text-sm">
              Create Seller Account →
            </button>
          </div>
        </div>
